...
<p><strong>Total Cost:</strong> $<span id="totalCost"></span></p>
    ...
    <div id="payment-success-popup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: white; padding: 20px; border: 1px solid #ccc; box-shadow: 2px 3px 10px rgba(0, 0, 0, 0.1);  height: 35%;">
        ...
        <p>Your Payment Is Successful</p><br>
        <h4>Our team will contact you soon</h4>
        <p>Click On Download for Reciept </p>
        <a href="tripbill.php" style="text-decoration:none;">Download</a>
...
if (totalCost !== null && totalCost !== undefined) {
    ...
    document.getElementById('totalCost').textContent = 'Total cost not available.';
}
